...
import com.funOfSchool.util.wheelview.adapter.SimpleWheelAdapter;
import com.funOfSchool.util.wheelview.common.WheelConstants;
import com.funOfSchool.util.wheelview.common.WheelViewException;
import com.funOfSchool.util.wheelview.graphics.DrawableFactory;
import com.funOfSchool.util.wheelview.util.WheelUtils;
import com.funOfSchool.util.wheelview.widget.IWheelView;
...
public class WheelView<T> extends ListView implements IWheelView<T> {
    ...
    private com.funOfSchool.util.wheelview.widget.WheelView mJoinWheelView;   // 副WheelView
    ...
    public void resetDataFromTop(final List<T> list) {
        ...
        com.funOfSchool.util.wheelview.widget.WheelView.this.postDelayed(new Runnable() {
            @Override
            public void run() {
                setWheelData(list);
                com.funOfSchool.util.wheelview.widget.WheelView.super.setSelection(0);
    ...
    public void setSelection(final int selection) {
        ...
        com.funOfSchool.util.wheelview.widget.WheelView.this.postDelayed(new Runnable() {
            @Override
            public void run() {
                com.funOfSchool.util.wheelview.widget.WheelView.super.setSelection(getRealPosition(selection));
                refreshCurrentPosition(false);
     ...
     */
    @Override
    public void join(com.funOfSchool.util.wheelview.widget.WheelView wheelView) {
        if (wheelView == null) {
