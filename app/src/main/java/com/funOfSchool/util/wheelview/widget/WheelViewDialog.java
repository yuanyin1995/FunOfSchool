 ...
 */
package com.funOfSchool.util.wheelview.widget;
...
import com.funOfSchool.util.wheelview.common.WheelConstants;
import com.funOfSchool.util.wheelview.util.WheelUtils;
...
public class WheelViewDialog<T> implements View.OnClickListener {
    ...
    private com.funOfSchool.util.wheelview.widget.WheelView<T> mWheelView;

    private com.funOfSchool.util.wheelview.widget.WheelView.WheelViewStyle mStyle;
    ...
    private void init() {
        ...
        mWheelView = new com.funOfSchool.util.wheelview.widget.WheelView(mContext);
        mWheelView.setSkin(com.funOfSchool.util.wheelview.widget.WheelView.Skin.Holo);
        mWheelView.setWheelAdapter(new ArrayWheelAdapter(mContext));
        mStyle = new com.funOfSchool.util.wheelview.widget.WheelView.WheelViewStyle();
     ...
     * @return
     */
    public com.funOfSchool.util.wheelview.widget.WheelViewDialog setOnDialogItemClickListener(OnDialogItemClickListener onDialogItemClickListener) {
     ...
     * @return
     */
    public com.funOfSchool.util.wheelview.widget.WheelViewDialog setDialogStyle(int color) {
     ...
     * @return
     */
    public com.funOfSchool.util.wheelview.widget.WheelViewDialog setTitle(String title) {
     ...
     * @return
     */
    public com.funOfSchool.util.wheelview.widget.WheelViewDialog setTextColor(int color) {
        mTitle.setTextColor(color);
        return this;
    }
     ...
     * @return
     */
    public com.funOfSchool.util.wheelview.widget.WheelViewDialog setTextSize(int size) {
     ...
     * @return
     */
    public com.funOfSchool.util.wheelview.widget.WheelViewDialog setButtonText(String text) {
     ...
     * @return
     */
    public com.funOfSchool.util.wheelview.widget.WheelViewDialog setButtonColor(int color) {
        mButton.setTextColor(color);
        return this;
    }
     ...
     * @return
     */
    public com.funOfSchool.util.wheelview.widget.WheelViewDialog setButtonSize(int size) {
     ...
     * @param count
     */
    public com.funOfSchool.util.wheelview.widget.WheelViewDialog setCount(int count) {
     ...
     * @param loop
     */
    public com.funOfSchool.util.wheelview.widget.WheelViewDialog setLoop(boolean loop) {
     ...
     * @param selection
     */
    public com.funOfSchool.util.wheelview.widget.WheelViewDialog setSelection(int selection) {
     ...
     * @param arrays
     */
    public com.funOfSchool.util.wheelview.widget.WheelViewDialog setItems(T[] arrays) {
     ...
     * @param list
     */
    public com.funOfSchool.util.wheelview.widget.WheelViewDialog setItems(List<T> list) {
     ...
     * 显示
     */
    public com.funOfSchool.util.wheelview.widget.WheelViewDialog show() {
     ...
     * 隐藏
     */
    public com.funOfSchool.util.wheelview.widget.WheelViewDialog dismiss() {
        if (mDialog.isShowing()) {
            mDialog.dismiss();
        }
        return this;
