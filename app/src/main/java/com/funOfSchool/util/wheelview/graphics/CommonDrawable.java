...
import com.funOfSchool.util.wheelview.graphics.WheelDrawable;
...
public class CommonDrawable extends WheelDrawable {
    ...
    public CommonDrawable(int width, int height, com.funOfSchool.util.wheelview.widget.WheelView.WheelViewStyle style, int wheelSize, int itemH) {
