 ...
 */
package com.funOfSchool.util.wheelview.adapter;
...
public abstract class BaseWheelAdapter<T> extends BaseAdapter {
    ...
    public final com.funOfSchool.util.wheelview.adapter.BaseWheelAdapter setClickable(boolean clickable) {
    ...
    public final com.funOfSchool.util.wheelview.adapter.BaseWheelAdapter setLoop(boolean loop) {
        if (loop != mLoop) {
            mLoop = loop;
            super.notifyDataSetChanged();
        }
    ...
    public final com.funOfSchool.util.wheelview.adapter.BaseWheelAdapter setWheelSize(int wheelSize) {
        mWheelSize = wheelSize;
        super.notifyDataSetChanged();
        return this;
    }

    public final com.funOfSchool.util.wheelview.adapter.BaseWheelAdapter setData(List<T> list) {
        mList = list;
        super.notifyDataSetChanged();
        return this;
    }
